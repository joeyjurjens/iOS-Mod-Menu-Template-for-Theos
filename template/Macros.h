...
//support for hooking with symbols instead of offsets
//Example if you see _Symbol you put "Symbol", same applies with __SomeSymbol you type _SomeSymbol, you remove the first underscore for some reason.
//HOOKSYM("_Test", _test, test);
